...
export default function NewAdvanceDialog({
  ...
  const handleProducerChange = (producer: AdvanceProducerOption | null) => {
    if (isEditMode) {
      return;
    }
    ...
    setForm((prev) => ({
      ...prev,
      bankAccountIndex: '',
      checkPayeeName: producer?.name || '',
      checkPayeeRut: producer?.rut || '',
    }));
  };
            ...
            <section className="rounded-xl border border-gray-200 bg-white p-5">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="md:col-span-2">
                  <AutoComplete<AdvanceProducerOption>
                    label="Productor"
                    placeholder={
                      isLoadingOptions
